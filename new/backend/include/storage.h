...
namespace api
{
	...
	public:
		METHOD_LIST_BEGIN
			METHOD_ADD(Storage::count, "/count", Options, Post, "api::JwtFilter");
		METHOD_ADD(Storage::info, "/info", Options, Post, "api::JwtFilter");
		METHOD_ADD(Storage::update, "/update", Options, Post, "api::JwtFilter");
		METHOD_LIST_END
